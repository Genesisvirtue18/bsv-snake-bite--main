...
function parseVideoLinks(value = '') {
    return String(value || '')
        ...
        .map((line, index) => {
            ...
            return {
                id: `${index}-${line}`,
                title: hasTitle ? parts[0] : `Training Video ${index + 1}`,
...
function getImageAlbums(card) {
    ...
    const normalized = albums
        .map((album, index) => ({
            ...
            title: album.title || `Training Album ${index + 1}`,
        ...
        return [
            {
                ...
                description: 'Training photos and webinar screenshots.',
...
export default function TrainingPage() {
    ...
    const trainingCard = content?.access?.items?.[0] || {}
        ...
        if (
            ...
            return trainingCard.trainingVideoItems
                .map((video, index) => {
                    ...
                    return {
                        id: `${index}-${url}`,
                        title: video.title || `Training Video ${index + 1}`,
                        url,
            ...
            <main className="container mx-auto px-4 pt-5 md:pt-7 pb-12">
                ...
                {showVideos && (
                    <section className="mb-10">
                        ...
                        {!videos.length ? (
                            <EmptyBox text="No training videos added yet." />
                        ) : (
                ...
                {showImages && (
                    <section className="mb-10">
                        ...
                        {!imageAlbums.length ? (
                            <EmptyBox text="No training image albums added yet." />
                        ) : (
                                        ...
                                        >
                                            ...
                                            <div className="p-4">
                                                <div className="font-display font-bold text-[#09084f] text-base line-clamp-2">
                                                    {album.title || `Training Album ${index + 1}`}
                                                </div>
                ...
                <Dialog open onOpenChange={() => setActiveAlbum(null)}>
                    <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                {activeAlbum.description || 'Training images and screenshots'}
                            </DialogDescription>
                        </DialogHeader>
